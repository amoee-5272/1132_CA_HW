...
def main():
    base_path = r"C:\Users\wuyiz\Documents\Computer_Architecture\workspace"
    
    # Loop over test indices.
    # For public tests: indices 0-4 (files answer_00.txt to answer_04.txt)
    # For private tests: indices 5-10 (files answer_05.txt to answer_10.txt)
    for i in range(11):  # 0 through 10
        ...
        if i < 5:
            ...
            answer_dir = os.path.join(base_path, "answer", "private")
            golden_dir = os.path.join(base_path, "golden", "private")
